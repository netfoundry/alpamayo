...
# SPDX-FileCopyrightText: Copyright (c) 2025 NetFoundry Inc. All rights reserved.
...
def main():
    parser = argparse.ArgumentParser(description="zitified Alpamayo-R1 Inference Example")
